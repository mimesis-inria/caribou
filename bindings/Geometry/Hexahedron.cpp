...
void create_hexahedron(pybind11::module & m) {
    ...
    m.def("Hexahedron", [](const caribou::bindings::Order & order) {
    ...
    // Linear creation
    m.def("Hexahedron", [](const Eigen::Matrix<FLOATING_POINT_TYPE, 8, 3> & nodes, const caribou::bindings::Order & order) {
