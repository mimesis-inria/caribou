...
class ControlFrame(Sofa.Core.Controller):
    ...
    def CreateGraph(self, root):
        ...
        sofa_node.addObject('CaribouTopology', name='topology', template=element_sofa, indices=mesh.cells[1].data.tolist())
        ...
        sofa_node.addObject('HyperelasticForcefield', topology='@topology', printLog=True)
