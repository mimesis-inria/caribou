...
if ELEMENT_TYPE == "Tetrahedron" and ELEMENT_APPROXIMATION_DEGREE == 1:
    ...
    mesh = meshio.read("./cube_tetra_1.msh")
    # mesh = meshio.read("./test.msh")
    # mesh = meshio.read("./beam_p1.msh")
    ...
    element_fenics = element_sofa
    mesh = meshio.read("./cube_tetra_2.msh")
    ...
    # mesh = meshio.read("./cube_hexa_1.msh")
    ...
    mesh = meshio.read("../meshes/refined_meshes/beam/q2/beam_q2_13.vtu")
