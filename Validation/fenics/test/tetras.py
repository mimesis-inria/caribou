...
def createScene(node):
    ...
    position = np.array([p_0, p_1, p_2, p_3])
    ...
    sofa_node.addObject('CaribouTopology', name='topology', template='Tetrahedron', indices=indices.tolist())
    ...
    fenics_node.addObject('CaribouTopology', name='topology', template='Tetrahedron', indices=indices.tolist())
    ...
    fenics_node.addObject('NeoHookeanMaterial_FEniCS', template="Tetrahedron", young_modulus="3000",
                          poisson_ratio="0.3")
