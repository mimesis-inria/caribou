...
class ControlFrame(Sofa.Core.Controller):
    ...
    def CreateGraph(self, root):
        ...
        # sofa_node.addObject('CaribouTopology', name='surface', template=element_surface,
                            ...
                            # indices=[[97, 20, 98, 101, 105, 113], [98, 23, 99, 106, 108, 114],
                            #          [98, 99, 100, 114, 115, 117]]
                            # indices=[[5, 23, 98, 24, 106, 104], [23, 6, 99, 25, 107, 108], [26, 7, 100, 28, 110, 111],
                            #          [99, 26, 100, 109, 111, 115], [29, 97, 100, 103, 116, 112]]
                            # indices=[
                            #     [5, 23, 98, 24, 106, 104], [23, 6, 99, 25, 107, 108], [26, 7, 100, 28, 110, 111],
                            #          [99, 26, 100, 109, 111, 115], [29, 97, 100, 103, 116, 112],
                            #          # [97, 20, 98, 101, 105, 113], [98, 23, 99, 106, 108, 114],
                            #     #      [98, 99, 100, 114, 115, 117],
                            #          # [29, 4, 97, 31, 102, 103], [20, 5, 98, 22, 104, 105],
                            #          # [6, 26, 99, 27, 109, 107],
                            #          # [7, 29, 100, 30, 112, 110], [97, 98, 100, 113, 117, 116],
                            #          [4, 20, 97, 21, 101, 102]
                            # ]
