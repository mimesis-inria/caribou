...
def createScene(node):
    ...
    node.addObject('StaticSolver', newton_iterations=number_of_newton_iterations, relative_correction_tolerance_threshold="1e-15", relative_residual_tolerance_threshold="1e-10", printLog=False)
