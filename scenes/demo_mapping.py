...
def createScene(root):
    ...
    beam.addObject('RegularGridTopology', template="Vec3d", name='mesh', min=[-0.5, -0.5, -4], max=[1, 1, 16], n=[2, 2, 4])
    ...
    point.addObject('MechanicalObject', name="point_mo", template='Rigid3d', position="  0.5 0.5 0 0 0 1 0   0.5 0.5 11 0 0 1 0  ")# 0.5 0.5 12 0 0 1 0   0.5 0.5 16 0 0 1 0 ")
    point.addObject('UniformMass', totalMass="1", showAxisSizeFactor="1")
    point.addObject("SphereCollisionModel", name="sphere", radius="1")
    point.addObject('MeshTopology', name='beam_topo', lines="0 1 ")
    point.addObject('BeamFEMForceField', name="FEM", radius="0.1", youngModulus="0.62e4", poissonRatio="0.40" )
    point.addObject('ConstantForceField', indices="0 1", forces="0 0 0  -1 0 0   0 0 0  -1 0 0 ")
