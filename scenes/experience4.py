...
def createScene(root):
    ...
    hexa.addObject('ConstantForceField', indices="9 19 29 39", force="1000 0 0 1000 0 0 1000 0 0 1000 0 00")
    ...
    target.addObject('MechanicalObject', name="target", template='Vec3d', position=[0, 0, 10, 5, 0, 10, 10, 0, 10, 15, 0, 10])
    ...
    for i in range(4):
        target.addObject('StiffSpringForceField', template="Vec3d", spring=str(i) + " " + str(i) + " 100000 0 0", object1="@../../beam_rigid/beam_vec", object2="@./")
