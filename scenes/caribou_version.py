...
def createScene(root):
    ...
    hexa.addObject('RegularGridTopology', template="Vec3d", name='mesh', min=[0, 0, 0], max=[3, 1, 1], n=[50, 8, 8])
    ...
    beam_rigid.addObject('MechanicalObject', name="beam_mo", template='Rigid3d', position=[0, 0.5, 0.5, 0, 0, 0, 1,   0.5, 0.5, 0.5, 0, 0, 0, 1,  1, 0.5, 0.5, 0, 0, 0, 1,   1.5, 0.5, 0.5, 0, 0, 0, 1,   2, 0.5, 0.5, 0, 0, 0, 1,   2.5, 0.5, 0.5, 0, 0, 0, 1,   3, 0.5, 0.5, 0, 0, 0, 1])#  15 0 0 0 0 0 1  -5 1.25 1.25 0 0 1 0  -2.5 1.25 1.25 0 0 1 0   0 1.25 1.25 0 0 1 0  2.5 1.25 1.25 0 0 1 0   5 1.25 1.25 0 0 1 0 ")
    ...
    beam_rigid.addObject('BeamFEMForceField', name="FEM", radius="0.5", youngModulus="6200", poissonRatio="0.40")
    #beam_rigid.addObject('ConstantForceField', indices="0 1 2 3", force="0 0 0 0 100 0")

    beam_vec = beam_rigid.addChild('beam_vec')
    beam_vec.addObject('MechanicalObject', name="beam_mo", template='Vec3d', position=[0, 0.5, 0.5,   0.5, 0.5, 0.5,  1, 0.5, 0.5,   1.5, 0.5, 0.5,   2, 0.5, 0.5,   2.5, 0.5, 0.5,   3, 0.5, 0.5])
    ...
    target.addObject('MechanicalObject', name="target", template='Vec3d', position=[0, 0.5, 0.5,   0.5, 0.5, 0.5,  1, 0.5, 0.5,   1.5, 0.5, 0.5,   2, 0.5, 0.5,   2.5, 0.5, 0.5,   3, 0.5, 0.5])
