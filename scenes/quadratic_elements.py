...
def createScene(root):
    ...
    root.tet10.addObject('CaribouTopology', name='topo', template='Tetrahedron10', indices=beam_p2.cells_dict['tetra10'].tolist())
    ...
    root.hex20.addObject('CaribouTopology', name='topo', template='Hexahedron20', indices=beam_q2.cells_dict['hexahedron20'].tolist())
