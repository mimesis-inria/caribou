...
/**
 * A Grid is a rectangular 2D quad (resp. 3D hexahedron) that contain multiple cell entities (regular lines in 1D, quads
 * in 2D and hexahedrons in 3D) aligned in the x, y [and z in 3D] axis.
...
struct Grid
{
     ...
     * @param subdivisions Vector of integers (nx, ny [, nz]) which specify the number of sub-cells in the x, y [and z] directions respectively
     * @param dimensions Vector of floats (sx, sy [, sz]) which specify the dimension of the grid from the anchor point in the x, y [and z] directions respectively
     */
