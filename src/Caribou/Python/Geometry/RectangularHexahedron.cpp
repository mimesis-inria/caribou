...
void create_rectangular_hexahedron(pybind11::module & m) {
    ...
    m.def("RectangularHexahedron", [](const caribou::bindings::Order & order) {
    ...
    m.def("RectangularHexahedron", [](const caribou::bindings::Order & order, const WorldCoordinates & center) {
        if (order == caribou::bindings::Order::Linear) {
    ...
    m.def("RectangularHexahedron", [](const caribou::bindings::Order & order, const WorldCoordinates & center, const Size & H) {
        if (order == caribou::bindings::Order::Linear) {
    ...
    m.def("RectangularHexahedron", [](const caribou::bindings::Order & order, const WorldCoordinates & center, const Size & H, const Rotation & R) {
        if (order == caribou::bindings::Order::Linear) {
    ...
    // Linear creation
    m.def("RectangularHexahedron", [](const Eigen::Matrix<FLOATING_POINT_TYPE, 8, 3> & nodes, const caribou::bindings::Order & order) {
    ...
    }, py::arg("n0"), py::arg("n1"), py::arg("n2"), py::arg("n3"), py::arg("n4"), py::arg("n5"), py::arg("n6"), py::arg("n7"), py::arg("order") = caribou::bindings::Order::Linear);
