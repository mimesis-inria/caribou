...
private:
    ...
    inline auto get_L(const LocalCoordinates & xi) const {
        ...
        m <<    (1/8.) * (1 - u) * (1 - v) * (1 + w), // Node 4
                (1/8.) * (1 + u) * (1 - v) * (1 + w), // Node 5
                (1/8.) * (1 - u) * (1 - v) * (1 - w), // Node 0
...
//            u * v * w;
    ...
    inline auto get_dL(const LocalCoordinates & xi) const {
        ...
        //            dL/m                         dL/dv                         dL/dw
        m << -1/8. * (1 - v) * (1 + w),    -1/8. * (1 - u) * (1 + w),    +1/8. * (1 - u) * (1 - v),   // Node 4
             +1/8. * (1 - v) * (1 + w),    -1/8. * (1 + u) * (1 + w),    +1/8. * (1 + u) * (1 - v),   // Node 5
             -1/8. * (1 - v) * (1 - w),    -1/8. * (1 - u) * (1 - w),    -1/8. * (1 - u) * (1 - v),   // Node 0
...
//        m << -v * w + v + w - 1,    -u * w + u + w -1,  -u * v + u + v - 1,
//              v * w - v - w + 1,    u * (w - 1),    u * (v - 1),
//              v * (w - 1),  u * w - u - w + 1,  v * (u - 1),
//              v * (1 - w),  u * (1 - w),    -u * w,
//              w * (v - 1),  w * (u - 1),    u * v - u - v + 1,
//              w * (1 - v),   -u * w,    u * (1 - v),
//             -v * w,   w * (1 - u),    v * (1 - u),
//              v * w,    u * w,  v * w;
        return m;
...
//        n[0] = 1/4.*(1 - u*u)*(1 - v)*(1 - w);
//        n[1] = 1/4.*(1 - v*v)*(1 + u)*(1 - w);
//        n[2] = 1/4.*(1 - u*u)*(1 + v)*(1 - w);
//        n[3] = 1/4.*(1 - v*v)*(1 - u)*(1 - w);
//        n[4] = 1/4.*(1 - u*u)*(1 - v)*(1 + w);
//        n[5] = 1/4.*(1 - v*v)*(1 + u)*(1 + w);
//        n[6] = 1/4.*(1 - u*u)*(1 + v)*(1 + w);
//        n[7] = 1/4.*(1 - v*v)*(1 - u)*(1 + w);
//        n[8] = 1/4.*(1 - w*w)*(1 - u)*(1 - v);
//        n[9] = 1/4.*(1 - w*w)*(1 + u)*(1 - v);
//        n[10] = 1/4.*(1 - w*w)*(1 + u)*(1 + v);
//        n[11] = 1/4.*(1 - w*w)*(1 - u)*(1 + v);

//        m[12] = 1/4.*(1 - u*u)*(1 - v)*(1 - w);
//        m[16] = 1/4.*(1 - v*v)*(1 + u)*(1 - w);
//        m[15] = 1/4.*(1 - u*u)*(1 + v)*(1 - w);
//        m[17] = 1/4.*(1 - v*v)*(1 - u)*(1 - w);
//        m[13] = 1/4.*(1 - u*u)*(1 - v)*(1 + w);
//        m[ 8] = 1/4.*(1 - v*v)*(1 + u)*(1 + w);
//        m[11] = 1/4.*(1 - u*u)*(1 + v)*(1 + w);
//        m[ 9] = 1/4.*(1 - v*v)*(1 - u)*(1 + w);
//        m[14] = 1/4.*(1 - w*w)*(1 - u)*(1 - v);
//        m[19] = 1/4.*(1 - w*w)*(1 + u)*(1 - v);
//        m[18] = 1/4.*(1 - w*w)*(1 + u)*(1 + v);
//        m[10] = 1/4.*(1 - w*w)*(1 - u)*(1 + v);

//        m[2] = 1/8.*(1 - u)*(1 - v)*(1 - w) - 1/2.*(n[ 0] + n[3] + n[8]);
//        m[3] = 1/8.*(1 + u)*(1 - v)*(1 - w) - 1/2.*(n[ 0] + n[ 1] + n[9]);
//        m[7] = 1/8.*(1 + u)*(1 + v)*(1 - w) - 1/2.*(n[ 1] + n[2] + n[10]);
//        m[6] = 1/8.*(1 - u)*(1 + v)*(1 - w) - 1/2.*(n[2] + n[3] + n[11]);
//        m[0] = 1/8.*(1 - u)*(1 - v)*(1 + w) - 1/2.*(n[4] + n[7] + n[8]);
//        m[1] = 1/8.*(1 + u)*(1 - v)*(1 + w) - 1/2.*(n[4] + n[5] + n[9]);
//        m[5] = 1/8.*(1 + u)*(1 + v)*(1 + w) - 1/2.*(n[5] + n[6] + n[10]);
//        m[4] = 1/8.*(1 - u)*(1 + v)*(1 + w) - 1/2.*(n[6] + n[7] + n[11]);

//        m[2] = 1/8.*(1 - u)*(1 - v)*(1 - w) - 1/2.*(m[12] + m[17] + m[14]);
//        m[3] = 1/8.*(1 + u)*(1 - v)*(1 - w) - 1/2.*(m[12] + m[16] + m[19]);
//        m[7] = 1/8.*(1 + u)*(1 + v)*(1 - w) - 1/2.*(m[16] + m[15] + m[18]);
//        m[6] = 1/8.*(1 - u)*(1 + v)*(1 - w) - 1/2.*(m[15] + m[17] + m[10]);
//        m[0] = 1/8.*(1 - u)*(1 - v)*(1 + w) - 1/2.*(m[13] + m[ 9] + m[14]);
//        m[1] = 1/8.*(1 + u)*(1 - v)*(1 + w) - 1/2.*(m[13] + m[ 8] + m[19]);
//        m[5] = 1/8.*(1 + u)*(1 + v)*(1 + w) - 1/2.*(m[ 8] + m[11] + m[18]);
//        m[4] = 1/8.*(1 - u)*(1 + v)*(1 + w) - 1/2.*(m[11] + m[ 9] + m[10]);

                    m[13] = 1/4.*(1 - u*u)*(1 - v)*(1 - w);
                    m[15] = 1/4.*(1 - v*v)*(1 + u)*(1 - w);
                    m[19] = 1/4.*(1 - u*u)*(1 + v)*(1 - w);
                    m[14] = 1/4.*(1 - v*v)*(1 - u)*(1 - w);
                    m[8 ] = 1/4.*(1 - u*u)*(1 - v)*(1 + w);
                    m[12] = 1/4.*(1 - v*v)*(1 + u)*(1 + w);
                    m[16] = 1/4.*(1 - u*u)*(1 + v)*(1 + w);
                    m[10] = 1/4.*(1 - v*v)*(1 - u)*(1 + w);
                    m[9 ] = 1/4.*(1 - w*w)*(1 - u)*(1 - v);
                    m[11] = 1/4.*(1 - w*w)*(1 + u)*(1 - v);
                    m[18] = 1/4.*(1 - w*w)*(1 + u)*(1 + v);
                    m[17] = 1/4.*(1 - w*w)*(1 - u)*(1 + v);

                    m[2] = 1/8.*(1 - u)*(1 - v)*(1 - w) - 1/2.*(m[13] + m[14] + m[9 ]);
                    m[3] = 1/8.*(1 + u)*(1 - v)*(1 - w) - 1/2.*(m[13] + m[15] + m[11]);
                    m[7] = 1/8.*(1 + u)*(1 + v)*(1 - w) - 1/2.*(m[15] + m[19] + m[18]);
                    m[6] = 1/8.*(1 - u)*(1 + v)*(1 - w) - 1/2.*(m[19] + m[14] + m[17]);
                    m[0] = 1/8.*(1 - u)*(1 - v)*(1 + w) - 1/2.*(m[8 ] + m[10] + m[9 ]);
                    m[1] = 1/8.*(1 + u)*(1 - v)*(1 + w) - 1/2.*(m[8 ] + m[12] + m[11]);
                    m[5] = 1/8.*(1 + u)*(1 + v)*(1 + w) - 1/2.*(m[12] + m[16] + m[18]);
                    m[4] = 1/8.*(1 - u)*(1 + v)*(1 + w) - 1/2.*(m[16] + m[10] + m[17]);
    ...
    inline auto get_dL(const LocalCoordinates & xi) const {
        ...
        Matrix<NumberOfNodesAtCompileTime, CanonicalDimension> m;
//        Matrix<12, CanonicalDimension> n;

        m.row(13) = ShapeDerivative({-1/2.*u*(1 - v)*(1 - w), -1/4.*(1 - u*u)*(1 - w), -1/4.*(1 - u*u)*(1 - v)});
        m.row(15) = ShapeDerivative({ 1/4.*(1 - v*v)*(1 - w), -1/2.*v*(1 + u)*(1 - w), -1/4.*(1 - v*v)*(1 + u)});
        m.row(19) = ShapeDerivative({-1/2.*u*(1 + v)*(1 - w),  1/4.*(1 - u*u)*(1 - w), -1/4.*(1 - u*u)*(1 + v)});
        m.row(14) = ShapeDerivative({-1/4.*(1 - v*v)*(1 - w), -1/2.*v*(1 - u)*(1 - w), -1/4.*(1 - v*v)*(1 - u)});
        m.row( 8) = ShapeDerivative({-1/2.*u*(1 - v)*(1 + w), -1/4.*(1 - u*u)*(1 + w),  1/4.*(1 - u*u)*(1 - v)});
        m.row(12) = ShapeDerivative({ 1/4.*(1 - v*v)*(1 + w), -1/2.*v*(1 + u)*(1 + w),  1/4.*(1 - v*v)*(1 + u)});
        m.row(16) = ShapeDerivative({-1/2.*u*(1 + v)*(1 + w),  1/4.*(1 - u*u)*(1 + w),  1/4.*(1 - u*u)*(1 + v)});
        m.row(10) = ShapeDerivative({-1/4.*(1 - v*v)*(1 + w), -1/2.*v*(1 - u)*(1 + w),  1/4.*(1 - v*v)*(1 - u)});
        m.row( 9) = ShapeDerivative({-1/4.*(1 - w*w)*(1 - v), -1/4.*(1 - w*w)*(1 - u), -1/2.*w*(1 - u)*(1 - v)});
        m.row(11) = ShapeDerivative({ 1/4.*(1 - w*w)*(1 - v), -1/4.*(1 - w*w)*(1 + u), -1/2.*w*(1 + u)*(1 - v)});
...
//                                                                dL/du                                                    dL/dv                                                           dL/dw
        m.row(2) = ShapeDerivative({-1/8.*(1 - v)*(1 - w) - 1/2.*(du[13] + du[14] + du[9 ]), -1/8.*(1 - u)*(1 - w) - 1/2.*(dv[13] + dv[14] + dv[9 ]), -1/8.*(1 - u)*(1 - v) - 1/2.*(dw[13] + dw[14] + dw[9 ])});
        m.row(3) = ShapeDerivative({ 1/8.*(1 - v)*(1 - w) - 1/2.*(du[13] + du[15] + du[11]), -1/8.*(1 + u)*(1 - w) - 1/2.*(dv[13] + dv[15] + dv[11]), -1/8.*(1 + u)*(1 - v) - 1/2.*(dw[13] + dw[15] + dw[11])});
        m.row(7) = ShapeDerivative({ 1/8.*(1 + v)*(1 - w) - 1/2.*(du[15] + du[19] + du[18]),  1/8.*(1 + u)*(1 - w) - 1/2.*(dv[15] + dv[19] + dv[18]), -1/8.*(1 + u)*(1 + v) - 1/2.*(dw[15] + dw[19] + dw[18])});
        m.row(6) = ShapeDerivative({-1/8.*(1 + v)*(1 - w) - 1/2.*(du[19] + du[14] + du[17]),  1/8.*(1 - u)*(1 - w) - 1/2.*(dv[19] + dv[14] + dv[17]), -1/8.*(1 - u)*(1 + v) - 1/2.*(dw[19] + dw[14] + dw[17])});
        m.row(0) = ShapeDerivative({-1/8.*(1 - v)*(1 + w) - 1/2.*(du[8 ] + du[10] + du[9 ]), -1/8.*(1 - u)*(1 + w) - 1/2.*(dv[8 ] + dv[10] + dv[9 ]),  1/8.*(1 - u)*(1 - v) - 1/2.*(dw[8 ] + dw[10] + dw[9 ])});
        m.row(1) = ShapeDerivative({ 1/8.*(1 - v)*(1 + w) - 1/2.*(du[8 ] + du[12] + du[11]), -1/8.*(1 + u)*(1 + w) - 1/2.*(dv[8 ] + dv[12] + dv[11]),  1/8.*(1 + u)*(1 - v) - 1/2.*(dw[8 ] + dw[12] + dw[11])});
        m.row(5) = ShapeDerivative({ 1/8.*(1 + v)*(1 + w) - 1/2.*(du[12] + du[16] + du[18]),  1/8.*(1 + u)*(1 + w) - 1/2.*(dv[12] + dv[16] + dv[18]),  1/8.*(1 + u)*(1 + v) - 1/2.*(dw[12] + dw[16] + dw[18])});
        m.row(4) = ShapeDerivative({-1/8.*(1 + v)*(1 + w) - 1/2.*(du[16] + du[10] + du[17]),  1/8.*(1 - u)*(1 + w) - 1/2.*(dv[16] + dv[10] + dv[17]),  1/8.*(1 - u)*(1 + v) - 1/2.*(dw[16] + dw[10] + dw[17])});

//        n.row(0) = ShapeDerivative({-1/2.*u*(1 - v)*(1 - w), -1/4.*(1 - u*u)*(1 - w), -1/4.*(1 - u*u)*(1 - v)});
//        n.row(1) = ShapeDerivative({ 1/4.*(1 - v*v)*(1 - w), -1/2.*v*(1 + u)*(1 - w), -1/4.*(1 - v*v)*(1 + u)});
//        n.row(2) = ShapeDerivative({-1/2.*u*(1 + v)*(1 - w),  1/4.*(1 - u*u)*(1 - w), -1/4.*(1 - u*u)*(1 + v)});
//        n.row(3) = ShapeDerivative({-1/4.*(1 - v*v)*(1 - w), -1/2.*v*(1 - u)*(1 - w), -1/4.*(1 - v*v)*(1 - u)});
//        n.row(4) = ShapeDerivative({-1/2.*u*(1 - v)*(1 + w), -1/4.*(1 - u*u)*(1 + w),  1/4.*(1 - u*u)*(1 - v)});
//        n.row(5) = ShapeDerivative({ 1/4.*(1 - v*v)*(1 + w), -1/2.*v*(1 + u)*(1 + w),  1/4.*(1 - v*v)*(1 + u)});
//        n.row(6) = ShapeDerivative({-1/2.*u*(1 + v)*(1 + w),  1/4.*(1 - u*u)*(1 + w),  1/4.*(1 - u*u)*(1 + v)});
//        n.row(7) = ShapeDerivative({-1/4.*(1 - v*v)*(1 + w), -1/2.*v*(1 - u)*(1 + w),  1/4.*(1 - v*v)*(1 - u)});
//        n.row(8) = ShapeDerivative({-1/4.*(1 - w*w)*(1 - v), -1/4.*(1 - w*w)*(1 - u), -1/2.*w*(1 - u)*(1 - v)});
//        n.row(9) = ShapeDerivative({ 1/4.*(1 - w*w)*(1 - v), -1/4.*(1 - w*w)*(1 + u), -1/2.*w*(1 + u)*(1 - v)});
//        n.row(10) = ShapeDerivative({ 1/4.*(1 - w*w)*(1 + v),  1/4.*(1 - w*w)*(1 + u), -1/2.*w*(1 + u)*(1 + v)});
//        n.row(11) = ShapeDerivative({-1/4.*(1 - w*w)*(1 + v),  1/4.*(1 - w*w)*(1 - u), -1/2.*w*(1 - u)*(1 + v)});

//        m.row(12) = ShapeDerivative({-1/2.*u*(1 - v)*(1 - w), -1/4.*(1 - u*u)*(1 - w), -1/4.*(1 - u*u)*(1 - v)});
//        m.row(16) = ShapeDerivative({ 1/4.*(1 - v*v)*(1 - w), -1/2.*v*(1 + u)*(1 - w), -1/4.*(1 - v*v)*(1 + u)});
//        m.row(15) = ShapeDerivative({-1/2.*u*(1 + v)*(1 - w),  1/4.*(1 - u*u)*(1 - w), -1/4.*(1 - u*u)*(1 + v)});
//        m.row(17) = ShapeDerivative({-1/4.*(1 - v*v)*(1 - w), -1/2.*v*(1 - u)*(1 - w), -1/4.*(1 - v*v)*(1 - u)});
//        m.row(13) = ShapeDerivative({-1/2.*u*(1 - v)*(1 + w), -1/4.*(1 - u*u)*(1 + w),  1/4.*(1 - u*u)*(1 - v)});
//        m.row( 8) = ShapeDerivative({ 1/4.*(1 - v*v)*(1 + w), -1/2.*v*(1 + u)*(1 + w),  1/4.*(1 - v*v)*(1 + u)});
//        m.row(11) = ShapeDerivative({-1/2.*u*(1 + v)*(1 + w),  1/4.*(1 - u*u)*(1 + w),  1/4.*(1 - u*u)*(1 + v)});
//        m.row( 9) = ShapeDerivative({-1/4.*(1 - v*v)*(1 + w), -1/2.*v*(1 - u)*(1 + w),  1/4.*(1 - v*v)*(1 - u)});
//        m.row(14) = ShapeDerivative({-1/4.*(1 - w*w)*(1 - v), -1/4.*(1 - w*w)*(1 - u), -1/2.*w*(1 - u)*(1 - v)});
//        m.row(19) = ShapeDerivative({ 1/4.*(1 - w*w)*(1 - v), -1/4.*(1 - w*w)*(1 + u), -1/2.*w*(1 + u)*(1 - v)});
//        m.row(18) = ShapeDerivative({ 1/4.*(1 - w*w)*(1 + v),  1/4.*(1 - w*w)*(1 + u), -1/2.*w*(1 + u)*(1 + v)});
//        m.row(10) = ShapeDerivative({-1/4.*(1 - w*w)*(1 + v),  1/4.*(1 - w*w)*(1 - u), -1/2.*w*(1 - u)*(1 + v)});

//        const auto du = n.col(0); // dL/du
//        const auto dv = n.col(1); // dL/dv
//        const auto dw = n.col(2); // dL/dw

//        //                                                        dL/du                                                    dL/dv                                                           dL/dw
//        m.row(2) = ShapeDerivative({-1/8.*(1 - v)*(1 - w) - 1/2.*(du[0] + du[3] + du[8]), -1/8.*(1 - u)*(1 - w) - 1/2.*(dv[0] + dv[3] + dv[8]), -1/8.*(1 - u)*(1 - v) - 1/2.*(dw[0] + dw[3] + dw[8])});
//        m.row(3) = ShapeDerivative({ 1/8.*(1 - v)*(1 - w) - 1/2.*(du[0] + du[1] + du[9]), -1/8.*(1 + u)*(1 - w) - 1/2.*(dv[0] + dv[1] + dv[9]), -1/8.*(1 + u)*(1 - v) - 1/2.*(dw[0] + dw[1] + dw[9])});
//        m.row(7) = ShapeDerivative({ 1/8.*(1 + v)*(1 - w) - 1/2.*(du[1] + du[2] + du[10]),  1/8.*(1 + u)*(1 - w) - 1/2.*(dv[1] + dv[2] + dv[10]), -1/8.*(1 + u)*(1 + v) - 1/2.*(dw[1] + dw[2] + dw[10])});
//        m.row(6) = ShapeDerivative({-1/8.*(1 + v)*(1 - w) - 1/2.*(du[2] + du[3] + du[11]),  1/8.*(1 - u)*(1 - w) - 1/2.*(dv[2] + dv[3] + dv[11]), -1/8.*(1 - u)*(1 + v) - 1/2.*(dw[2] + dw[3] + dw[11])});
//        m.row(0) = ShapeDerivative({-1/8.*(1 - v)*(1 + w) - 1/2.*(du[4] + du[7] + du[8]), -1/8.*(1 - u)*(1 + w) - 1/2.*(dv[4] + dv[7] + dv[8]),  1/8.*(1 - u)*(1 - v) - 1/2.*(dw[4] + dw[7] + dw[8])});
//        m.row(1) = ShapeDerivative({ 1/8.*(1 - v)*(1 + w) - 1/2.*(du[4] + du[5] + du[9]), -1/8.*(1 + u)*(1 + w) - 1/2.*(dv[4] + dv[5] + dv[9]),  1/8.*(1 + u)*(1 - v) - 1/2.*(dw[4] + dw[5] + dw[9])});
//        m.row(5) = ShapeDerivative({ 1/8.*(1 + v)*(1 + w) - 1/2.*(du[5] + du[6] + du[10]),  1/8.*(1 + u)*(1 + w) - 1/2.*(dv[5] + dv[6] + dv[10]),  1/8.*(1 + u)*(1 + v) - 1/2.*(dw[5] + dw[6] + dw[10])});
//        m.row(4) = ShapeDerivative({-1/8.*(1 + v)*(1 + w) - 1/2.*(du[6] + du[7] + du[11]),  1/8.*(1 - u)*(1 + w) - 1/2.*(dv[6] + dv[7] + dv[11]),  1/8.*(1 - u)*(1 + v) - 1/2.*(dw[6] + dw[7] + dw[11])});
        //    //                                                        dL/du                                                    dL/dv                                                           dL/dw
        //    m.row(2) = ShapeDerivative({-1/8.*(1 - v)*(1 - w) - 1/2.*(du[12] + du[17] + du[14]), -1/8.*(1 - u)*(1 - w) - 1/2.*(dv[12] + dv[17] + dv[14]), -1/8.*(1 - u)*(1 - v) - 1/2.*(dw[12] + dw[17] + dw[14])});
        //    m.row(3) = ShapeDerivative({ 1/8.*(1 - v)*(1 - w) - 1/2.*(du[12] + du[16] + du[19]), -1/8.*(1 + u)*(1 - w) - 1/2.*(dv[12] + dv[16] + dv[19]), -1/8.*(1 + u)*(1 - v) - 1/2.*(dw[12] + dw[16] + dw[19])});
        //    m.row(7) = ShapeDerivative({ 1/8.*(1 + v)*(1 - w) - 1/2.*(du[16] + du[15] + du[18]),  1/8.*(1 + u)*(1 - w) - 1/2.*(dv[16] + dv[15] + dv[18]), -1/8.*(1 + u)*(1 + v) - 1/2.*(dw[16] + dw[15] + dw[18])});
        //    m.row(6) = ShapeDerivative({-1/8.*(1 + v)*(1 - w) - 1/2.*(du[15] + du[17] + du[10]),  1/8.*(1 - u)*(1 - w) - 1/2.*(dv[15] + dv[17] + dv[10]), -1/8.*(1 - u)*(1 + v) - 1/2.*(dw[15] + dw[17] + dw[10])});
        //    m.row(0) = ShapeDerivative({-1/8.*(1 - v)*(1 + w) - 1/2.*(du[13] + du[ 9] + du[14]), -1/8.*(1 - u)*(1 + w) - 1/2.*(dv[13] + dv[ 9] + dv[14]),  1/8.*(1 - u)*(1 - v) - 1/2.*(dw[13] + dw[ 9] + dw[14])});
        //    m.row(1) = ShapeDerivative({ 1/8.*(1 - v)*(1 + w) - 1/2.*(du[13] + du[ 8] + du[19]), -1/8.*(1 + u)*(1 + w) - 1/2.*(dv[13] + dv[ 8] + dv[19]),  1/8.*(1 + u)*(1 - v) - 1/2.*(dw[13] + dw[ 8] + dw[19])});
        //    m.row(5) = ShapeDerivative({ 1/8.*(1 + v)*(1 + w) - 1/2.*(du[ 8] + du[11] + du[18]),  1/8.*(1 + u)*(1 + w) - 1/2.*(dv[ 8] + dv[11] + dv[18]),  1/8.*(1 + u)*(1 + v) - 1/2.*(dw[ 8] + dw[11] + dw[18])});
        //    m.row(4) = ShapeDerivative({-1/8.*(1 + v)*(1 + w) - 1/2.*(du[11] + du[ 9] + du[10]),  1/8.*(1 - u)*(1 + w) - 1/2.*(dv[11] + dv[ 9] + dv[10]),  1/8.*(1 - u)*(1 + v) - 1/2.*(dw[11] + dw[ 9] + dw[10])});
