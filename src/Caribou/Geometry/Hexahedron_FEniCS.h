...
template<>
struct traits<Hexahedron_FEniCS <Linear>> {
 ...
 */
template<>
struct Hexahedron_FEniCS <Linear> : public BaseHexahedron<Hexahedron_FEniCS <Linear>> {
    // Types
    using Base = BaseHexahedron<Hexahedron_FEniCS <Linear>>;
...
private:
    // Implementations
    friend struct Element<Hexahedron_FEniCS <Linear>>;
    friend struct BaseHexahedron<Hexahedron_FEniCS <Linear>>;
...
template<>
struct traits<Hexahedron_FEniCS <Quadratic>> {
    static constexpr UNSIGNED_INTEGER_TYPE CanonicalDimension = 3;
    static constexpr UNSIGNED_INTEGER_TYPE Dimension = 3;
...
/**
 * Quadratic Hexahedron_FEniCS (20 nodes)
 *
 * \verbatim
 *         v
 *         ^
 ...
 */
template<>
struct Hexahedron_FEniCS <Quadratic> : public BaseHexahedron<Hexahedron_FEniCS <Quadratic>> {
    // Types
    using Base = BaseHexahedron<Hexahedron_FEniCS <Quadratic>>;
    using LocalCoordinates = typename Base::LocalCoordinates;
    using WorldCoordinates = typename Base::WorldCoordinates;
    ...
    explicit Hexahedron_FEniCS(const Hexahedron_FEniCS<Linear> & linear_Hexahedron_FEniCS) : Base() {
    ...
    /** Construct a quadratic Hexahedron_FEniCS from eight nodes */
    Hexahedron_FEniCS(WorldCoordinates & p0, WorldCoordinates & p1, WorldCoordinates & p2, WorldCoordinates & p3, WorldCoordinates & p4, WorldCoordinates & p5, WorldCoordinates & p6, WorldCoordinates & p7)
        : Hexahedron_FEniCS(Hexahedron_FEniCS<Linear>(p0, p1, p2, p3, p4, p5, p6, p7)) {}

    /** Construct a quadratic Hexahedron_FEniCS from eight nodes */
    Hexahedron_FEniCS(const WorldCoordinates & p0, const WorldCoordinates & p1, const WorldCoordinates & p2, const WorldCoordinates & p3, const WorldCoordinates & p4, const WorldCoordinates & p5, const WorldCoordinates & p6, const WorldCoordinates & p7)
        : Hexahedron_FEniCS(Hexahedron_FEniCS<Linear>(p0, p1, p2, p3, p4, p5, p6, p7)) {}
...
private:
    // Implementations
    friend struct Element<Hexahedron_FEniCS <Quadratic>>;
    friend struct BaseHexahedron<Hexahedron_FEniCS <Quadratic>>;
    inline auto get_L(const LocalCoordinates & xi) const {
        const auto  & u = xi[0];
        const auto  & v = xi[1];
        const auto  & w = xi[2];
