 ...
 *
 */
struct Hexahedron20: public BaseHexahedron<Hexahedron20> {
    // Types
    using Base = BaseHexahedron<Hexahedron20>;
    ...
    explicit Hexahedron20(const Hexahedron & linear_Hexahedron) : Base() {
    ...
    Hexahedron20(WorldCoordinates & p0, WorldCoordinates & p1, WorldCoordinates & p2, WorldCoordinates & p3, WorldCoordinates & p4, WorldCoordinates & p5, WorldCoordinates & p6, WorldCoordinates & p7)
    : Hexahedron20(Hexahedron(p0, p1, p2, p3, p4, p5, p6, p7)) {}

    /** Construct a quadratic Hexahedron from eight nodes */
    Hexahedron20(const WorldCoordinates & p0, const WorldCoordinates & p1, const WorldCoordinates & p2, const WorldCoordinates & p3, const WorldCoordinates & p4, const WorldCoordinates & p5, const WorldCoordinates & p6, const WorldCoordinates & p7)
    : Hexahedron20(Hexahedron(p0, p1, p2, p3, p4, p5, p6, p7)) {}
...
private:
    // Implementations
    friend struct Element<Hexahedron20>;
    friend struct BaseHexahedron<Hexahedron20>;
