...
void create_tetrahedrons(pybind11::module & m) {
    ...
    tet4.def("Tinv", &Tetrahedron<interpolation::Tetrahedron4>::Tinv);
    tet4.def("contains", &Tetrahedron<interpolation::Tetrahedron4>::contains);
    tet4.def("jacobian", &Tetrahedron<interpolation::Tetrahedron4>::jacobian);
    tet4.def_property_readonly_static("gauss_nodes", [](const py::object & /* self */){
    ...
    tet4.def_property_readonly_static("gauss_weights", [](const py::object & /* self */){
    ...
    tet4.def_static("interpolate", [](const typename Tetrahedron<interpolation::Tetrahedron4>::LocalCoordinates & p, Eigen::Ref<const Eigen::Matrix<FLOATING_POINT_TYPE, Tetrahedron<interpolation::Tetrahedron4>::NumberOfNodes, 3, Eigen::RowMajor>> values) {
        return Tetrahedron<interpolation::Tetrahedron4>::interpolate(p, values);
    });
    ...
    tet10.def_property_readonly_static("gauss_nodes", [](const py::object & /* self */){
    ...
    tet10.def_property_readonly_static("gauss_weights", [](const py::object & /* self */){
    ...
    tet10.def_static("interpolate", [](const typename Tetrahedron<interpolation::Tetrahedron10>::LocalCoordinates & p, Eigen::Ref<const Eigen::Matrix<FLOATING_POINT_TYPE, Tetrahedron<interpolation::Tetrahedron10>::NumberOfNodes, 3, Eigen::RowMajor>> values) {
        return Tetrahedron<interpolation::Tetrahedron10>::interpolate(p, values);
    });
}
