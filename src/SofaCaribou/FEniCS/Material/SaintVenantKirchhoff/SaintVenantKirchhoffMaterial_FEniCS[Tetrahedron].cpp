...
template<>
ufcx_integral* SaintVenantKirchhoffMaterial_FEniCS<Tetrahedron<caribou::Linear >, sofa::defaulttype::Vec3Types>::FEniCS_F() {
        ufcx_integral *integral = form_SaintVenantKirchhoff_Tetra_F->integrals(ufcx_integral_type::cell)[0];
        return integral;
    }
template<>
ufcx_integral* SaintVenantKirchhoffMaterial_FEniCS<Tetrahedron<caribou::Linear >, sofa::defaulttype::Vec3Types>::FEniCS_J() {
        ufcx_integral *integral = form_SaintVenantKirchhoff_Tetra_J->integrals(ufcx_integral_type::cell)[0];
        return integral;
    }

template class SaintVenantKirchhoffMaterial_FEniCS<caribou::geometry::Tetrahedron<caribou::Quadratic>, sofa::defaulttype::Vec3Types>;
template <>
ufcx_integral* SaintVenantKirchhoffMaterial_FEniCS<Tetrahedron<caribou::Quadratic >, sofa::defaulttype::Vec3Types>::FEniCS_F()  {
        ufcx_integral *integral = form_SaintVenantKirchhoff_Tetra_Order2_F->integrals(ufcx_integral_type::cell)[0];
        return integral;
    }
template <>
ufcx_integral* SaintVenantKirchhoffMaterial_FEniCS<Tetrahedron<caribou::Quadratic >, sofa::defaulttype::Vec3Types>::FEniCS_J()  {
...
/* Linear */         .add<SaintVenantKirchhoffMaterial_FEniCS<Tetrahedron<caribou::Linear >, sofa::defaulttype::Vec3Types>>()
/* Qudratic */       .add<SaintVenantKirchhoffMaterial_FEniCS<Tetrahedron<caribou::Quadratic >, sofa::defaulttype::Vec3Types>>();
