...
#include <SofaCaribou/FEniCS/Material/NeoHookean/NeoHookeanMaterial_FEniCS[Tetrahedron].h>
...
template<>
ufcx_integral* NeoHookeanMaterial_FEniCS<Tetrahedron, sofa::defaulttype::Vec3Types>::FEniCS_Pi() {
