...
void bind_hyperelastic_forcefield_FEniCS(pybind11::module &m, const std::string & template_name) {
    ...
    c.def("psi", &HyperelasticForcefield_FEniCS<Element>::psi);
    c.def("getEnergy", [](HyperelasticForcefield_FEniCS<Element> & self, const Eigen::Matrix<double, Eigen::Dynamic, HyperelasticForcefield_FEniCS<Element>::Dimension, Eigen::RowMajor> & x, const Eigen::Matrix<double, Eigen::Dynamic, HyperelasticForcefield_FEniCS<Element>::Dimension, Eigen::RowMajor> & x0) {
        self.getEnergy(x, x0);
    }, pybind11::arg("x").noconvert(true), pybind11::arg("x0").noconvert(true));
//    c.def("getEnergy", [](HyperelasticForcefield_FEniCS<Element> & self, const Eigen::Matrix<float, Eigen::Dynamic, HyperelasticForcefield_FEniCS<Element>::Dimension, Eigen::RowMajor> & x, const Eigen::Matrix<float, Eigen::Dynamic, HyperelasticForcefield_FEniCS<Element>::Dimension, Eigen::RowMajor> & x0) {
//        self.getEnergy(x, x0);
