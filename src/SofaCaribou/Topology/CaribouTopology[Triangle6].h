...
template<> auto CaribouTopology<caribou::geometry::Triangle6<caribou::_2D>>::templateName(
        const CaribouTopology<caribou::geometry::Triangle6<caribou::_2D>> *) -> std::string;
...
template<> auto CaribouTopology<caribou::geometry::Triangle6<caribou::_3D>>::templateName(
        const CaribouTopology<caribou::geometry::Triangle6<caribou::_3D>> *) -> std::string;
