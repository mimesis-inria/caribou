...
class HyperelasticForcefield_ACEgen : public CaribouForcefield<Element> {
public:
    SOFA_CLASS(SOFA_TEMPLATE(HyperelasticForcefield_ACEgen, Element), SOFA_TEMPLATE(CaribouForcefield, Element));
    ...
    using Link = sofa::core::objectmodel::SingleLink<HyperelasticForcefield_ACEgen<Element>, ObjectType, sofa::core::objectmodel::BaseLink::FLAG_STRONGLINK>;

    
    // Public methods

    
    HyperelasticForcefield_ACEgen();
