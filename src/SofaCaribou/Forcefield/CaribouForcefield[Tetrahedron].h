...
template <> void CaribouForcefield<caribou::geometry::Tetrahedron>::triangulate_face(const caribou::geometry::Tetrahedron & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
