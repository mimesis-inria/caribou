#include <SofaCaribou/Forcefield/TractionForcefield[Quad8].h>
...
template class TractionForcefield<Quad8<_2D>>;
template class TractionForcefield<Quad8<_3D>>;
...
static int _c_ = RegisterObject("Caribou traction force field")
        .add<TractionForcefield<Quad8<_2D>>>()
        .add<TractionForcefield<Quad8<_3D>>>();
}
