...
template <> void CaribouForcefield<caribou::geometry::Hexahedron20>::triangulate_face(const caribou::geometry::Hexahedron20 & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
