...
template <> void CaribouForcefield<caribou::geometry::Quad < caribou::_2D, caribou::Linear>>::triangulate_face(const caribou::geometry::Quad < caribou::_2D, caribou::Linear> & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
...
template <> void CaribouForcefield<caribou::geometry::Quad < caribou::_3D, caribou::Linear>>::triangulate_face(const caribou::geometry::Quad < caribou::_3D, caribou::Linear> & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
...
template <> void CaribouForcefield<caribou::geometry::Quad < caribou::_2D, caribou::Quadratic>>::triangulate_face(const caribou::geometry::Quad < caribou::_2D, caribou::Quadratic> & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
...
template <> void CaribouForcefield<caribou::geometry::Quad < caribou::_3D, caribou::Quadratic>>::triangulate_face(const caribou::geometry::Quad < caribou::_3D, caribou::Quadratic> & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
