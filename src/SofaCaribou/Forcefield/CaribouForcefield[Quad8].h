...
template <> void CaribouForcefield<caribou::geometry::Quad8<caribou::_2D>>::triangulate_face(const caribou::geometry::Quad8<caribou::_2D> & e, const std::size_t & face_id, std::vector<sofa::type::Vec3> & triangles_nodes);
...
template <> void CaribouForcefield<caribou::geometry::Quad8<caribou::_3D>>::triangulate_face(const caribou::geometry::Quad8<caribou::_3D> & e, const std::size_t & face_id, std::vector<sofa::type::Vec3> & triangles_nodes);
