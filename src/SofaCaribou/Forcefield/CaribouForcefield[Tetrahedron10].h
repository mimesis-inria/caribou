...
template <> void CaribouForcefield<caribou::geometry::Tetrahedron10>::triangulate_face(const caribou::geometry::Tetrahedron10 & e, const std::size_t & face_id, std::vector<sofa::type::Vector3> & triangles_nodes);
