...
template <>
void CaribouForcefield<Quad<_2D>>::triangulate_face(const Quad<_2D> & e, const std::size_t & /*face_id*/, std::vector<sofa::type::Vec3> & triangles_nodes) {
...
template <>
void CaribouForcefield<Quad<_3D>>::triangulate_face(const Quad<_3D> & e, const std::size_t & /*face_id*/, std::vector<sofa::type::Vec3> & triangles_nodes) {
    auto triangle_1 = std::vector {e.node(0), e.node(1), e.node(2)};
    auto triangle_2 = std::vector {e.node(2), e.node(3), e.node(0)};
    for (const auto &n : triangle_1) {
