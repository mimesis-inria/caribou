...
template class CaribouBarycentricMapping<caribou::geometry::Hexahedron, sofa::defaulttype::Vec3Types>;
...
.add<CaribouBarycentricMapping<Hexahedron, sofa::defaulttype::Vec3Types>>();
}