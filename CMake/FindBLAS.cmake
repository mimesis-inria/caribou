    ...
    if(_libraries_work)
      if (BLA_STATIC AND NOT is_omp)
        ...
        if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
          ...
          set(CMAKE_FIND_LIBRARY_SUFFIXES .so ${CMAKE_FIND_LIBRARY_SUFFIXES} .so.3gf)
        endif ()
      endif ()
...
if (BLA_VENDOR MATCHES "Intel" OR BLA_VENDOR STREQUAL "All")
  if (NOT BLAS_LIBRARIES)
    ...
    if (WIN32)
      ...
      if(((CMAKE_Fortran_COMPILER_LOADED AND CMAKE_Fortran_COMPILER_ID STREQUAL "GNU") OR
